...
export const metadata: Metadata = {
  ...
  description:
    "1893–1917. Tesla's tower at Wardenclyffe — free energy for every human being, wirelessly, for free. The frequency they tried to silence.",
};
  ...
  return (
    <main className="relative min-h-screen bg-past-cream text-past-ink">
        ...
        <div className="grid items-center gap-12 md:grid-cols-[1.4fr_1fr]">
          <div>
            ...
            <blockquote className="mt-10 max-w-reading border-l-2 border-past-gold pl-6 font-serif text-2xl italic leading-relaxed text-past-ink/80">
              ...
              <cite className="mt-3 block font-sans text-sm not-italic text-past-ink/50">
                — Nikola Tesla
              </cite>
            </blockquote>
          </div>

          {/* Schematic + the reaching gesture: a hand of light reaching up,
              an arc reaching down, a gap left unresolved.
              TODO(mascot): place mascot-tower.png at the base of this schematic. */}
          <div className="relative mx-auto h-[26rem] w-full max-w-xs">
            <div className="absolute inset-0 rounded-xl border border-past-ink/15 bg-[#efe2c6]/60 p-6 shadow-[0_2px_30px_-12px_rgba(26,20,16,0.4)]">
              <TowerSchematic />
            </div>
            <div
              aria-hidden="true"
              className="absolute -right-2 top-6 h-24 w-px bg-gradient-to-b from-past-gold to-transparent"
            />
            <p className="absolute -bottom-8 left-0 font-mono text-[0.65rem] uppercase tracking-ritual text-past-ink/40">
      ...
      <Section kicker="The Vision">
        ...
        <p>
          No meter. No bill. No gatekeeper. Energy travels at the speed of light
          — and Tesla believed value should travel the same way.
        </p>
      </Section>
      ...
      <section className="relative border-y border-past-ink/10 bg-[#efe2c6]/50 px-6 py-28">
        <Reveal className="mx-auto max-w-reading">
          ...
          <blockquote className="mt-6 font-serif text-2xl leading-relaxed sm:text-3xl">
            ...
            <cite className="mt-4 block font-sans text-sm not-italic text-past-ink/50">
              — Nikola Tesla
            </cite>
          </blockquote>
