...
export function initZappChart() {
  ...
  function draw(rows: number[][]) {
    ...
    ctx.strokeStyle = 'rgba(29,185,84,.1)'; ctx.fillStyle = 'rgba(166,240,200,.6)';
    ...
    g.addColorStop(0, 'rgba(29,185,84,.32)'); g.addColorStop(1, 'rgba(29,185,84,0)');
