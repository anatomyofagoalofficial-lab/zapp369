...
export function initZappChart() {
  ...
  function draw(rows: number[][]) {
    ...
    ctx.strokeStyle = 'rgba(70,200,78,.1)'; ctx.fillStyle = 'rgba(166,240,200,.6)';
    ...
    g.addColorStop(0, 'rgba(70,200,78,.32)'); g.addColorStop(1, 'rgba(70,200,78,0)');
